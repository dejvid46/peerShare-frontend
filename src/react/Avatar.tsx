...
import YourSvg from "../icons/0.svg";
...
export default function Avatar({icon, rotate, translateX }: AvatarProps) {
  ...
  return (
    <div style={{ transform: `rotate(${rotate}deg) translateX(${translateX}%)` }} className="absolute sm:h-16 sm:w-16 sm:left-[calc(50%_-_32px)] sm:top-[calc(50%_-_32px)] h-12 w-12 left-[calc(50%_-_24px)] top-[calc(50%_-_24px)] rounded-[50%]">
